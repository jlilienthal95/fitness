<div class="flex w-full md:h-full flex-col items-start md:flex-row gap-10">
	<div class="hidden md:flex md:h-full w-full flex-col justify-between">
		<div class="flex flex-row items-center">
			<img src="/assets/AS-logo-simple-HQ.png" alt="Armstrong Strength Logo" class="md:flex hidden size-30 object-contain hover:saturate-150"/>
			<div class="oswald-bold w-full text-end text-2xl lg:text-4xl">
				TRANSFORM YOUR BODY WITH FUNCTIONAL TRAINING
			</div>
		</div>
		<div class="flex w-full h-full justify-end flex-1 flex-row items-center">
			<div class="lg:w-1/2"></div>
			<div class="oswald-bold w-full flex-1 text-center text-xl md:static">
				...
				MOVEMENT PATTERNS THAT MIRROR EVERYDAY TASKS, HELPING YOU LIFT SMARTER, MOVE BETTER, AND
				FEEL STRONGER ALL DAY, EVERY DAY. IT’S NOT JUST ABOUT LOOKING FIT, IT’S ABOUT BEING CAPABLE.
			</div>
		</div>
	</div>
